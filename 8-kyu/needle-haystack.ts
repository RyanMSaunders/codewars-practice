export function findNeedle(haystack: any[]): string {
  const needlePostion = haystack.findIndex((element) => element === "needle")
  return `found the needle at position ${needlePostion}`
}
...
returning string that says "found the needle at position x"

input an array of strings, with one item being 'needle
